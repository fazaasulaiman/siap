...
<div class="container">
    <div class="ml-5">
        <h1 class="mt-5">Form Input Penolakan</h1>
        Silahkan masukan data penolakan
        <hr />
        <div class="error"></div>
        <form method="post" id="tambah" enctype="multipart/form-data">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-7">
                    <select id="penolakan" name="penolakan" class="form-control" onChange="removeError('penolakan')">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-7">
                    <div class="custom-file">
                        ...
                        <div class="invalid-feedback">sdfdfsdfds</div>
                    </div>
                </div>
            </div>
            <div class="mb-3 row">
                ...
                <div class="col-sm-7">
                    <span>Info file yang diupload</span>
                </div>
            </div>
        </form>
...
<script>
    $(function() {
        // $('input[type=text], select,input[type=radio],input[type=file] ').change(function(event) {
        //     console.log('ohjia')
