...
<div class="container">
    <div class="ml-5">
        <h1 class="mt-5">Register Form Seksi Pemeriksaan</h1>
        Silahkan Daftarkan User Seksi Pemeriksaan
        <hr />
        <form method="post" id="tambah">
            <?= csrf_field(); ?>
            <input type="hidden" value="seksi" name="level">
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
                <label for="inputPassword" class="col-sm-2 col-form-label">Seksi Pemeriksaan</label>
                <div class="col-sm-7">
                    <select id="seksi" name="keterangan" class="form-control" onChange="removeError('keterangan')">
                        <option value="">Pilih Seksi Pemeriksaan</option>
                        <option value="Seksi Pemeriksaan I">Seksi Pemeriksaan I</option>
                        <option value="Seksi Pemeriksaan II">Seksi Pemeriksaan II</option>
                        <option value="Seksi Pemeriksaan III">Seksi Pemeriksaan III</option>
                        <option value="Seksi Pemeriksaan IV">Seksi Pemeriksaan IV</option>
                    </select>
                    <div class="invalid-feedback"></div>
                </div>
            </div>
            ...
            <form method="post" id="update">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="invalid-feedback">fsdfsdf</div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="password1">Seksi Pemeriksaan</label>
                        <select id="keterangan-update" name="keterangan" class="form-control" onChange="removeError('keterangan')">
                            <option value="">Pilih Seksi Pemeriksaan</option>
                            <option value="Seksi Pemeriksaan I">Seksi Pemeriksaan I</option>
                            <option value="Seksi Pemeriksaan II">Seksi Pemeriksaan II</option>
                            <option value="Seksi Pemeriksaan III">Seksi Pemeriksaan III</option>
...
<script>
    ...
    function update() {
        ...
        $.ajax({
            context: this,
            url: 'register/seksi/' + $('#id-update').val() + '/edit',
            headers: {
                'X-Requested-With': 'XMLHttpRequest'
            },
            type: "get",
