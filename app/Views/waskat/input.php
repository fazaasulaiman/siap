...
<div class="container">
    <div class="ml-5">
        <h1 class="mt-5">Form Input Waskat</h1>
        Silahkan masukan data waskat
        <hr />
        <div class="error"></div>
        <form method="post" id="tambah" enctype="multipart/form-data">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-7">
                    <input type="text" class="form-control" name="noRegistrasi" onChange="removeError('noRegistrasi')">
                    <div class="invalid-feedback"></div>
                </div>
            </div>
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-7">
                    <span>Upload Laporan Kejadian Waskat beserta lampirannya jika ada</span>
                </div>
            </div>
        </form>
